...
\CVItem{Professional}{
Topics on software quality, TDD, software design and functional Languages. 
I keep up to date by 
attending software 
meetups (Lisbon JUG, the 
Virtual JUG and the
Software Craftsmanship
Community in Lisbon). I also pickup technical reads.}
...
\begin{itemize}
	\item Built and launched Cadi to 7 different European markets with a small multi functional team
    ...
    \item Solutions design and development for several micro-services and integration with in-house built e-commerce solutions
\end{itemize}
}
...
Worked building and maintaining customer management tool for French company specialized in cold chain transportation and logistic
\begin{itemize}
